                        ...
                        {currentProducts.map((product) => (
                            ...
                            >
                                ...
                                <div className="px-3 pb-2 pt-1 md:px-4 md:pb-2">
                                    ...
                                    <p className="hidden text-md text-[#8b95a7] md:block md:min-h-[50px] md:text-md">
                                        {product.description}
                                    </p>
                    ...
                    {totalPages > 1 && (
                        <div className="mt-8 flex items-center justify-center gap-3 md:mt-10 md:gap-4">
                            ...
                            <button
                                ...
                                className={`flex h-8 w-8 items-center justify-center rounded-full transition md:h-14 md:w-10 ${currentPage === 1
                            ...
                            {totalPages >= 1 && (
                                <button
                                    ...
                                    className={`text-lg font-medium transition ${currentPage === 1
                            ...
                            {totalPages >= 2 && (
                                <button
                                    ...
                                    className={`text-lg font-medium transition ${currentPage === 2
                                        ? 'flex h-8 w-8 items-center justify-center rounded-xl bg-[#8b3dff] text-white md:h-10 md:w-10'
                                        : 'text-[#111827]'
                                        }`}
                                >
                            ...
                            {totalPages >= 3 && (
                                <button
                                    ...
                                    className={`text-lg font-medium transition ${currentPage === 3
                            ...
                            {totalPages >= 4 && (
                                <button
                                    ...
                                    className={`text-lg font-medium transition ${currentPage === 4
                                        ? 'flex h-12 w-12 items-center justify-center rounded-full bg-[#8b3dff] text-white md:h-14 md:w-14'
                                        : 'text-[#111827]'
                                        }`}
                                >
                            ...
                            {/* DOTS */}
                            {totalPages > 5 && (
                                <span className="px-1 text-lg font-medium text-[#111827]">...</span>
                            )}
                            ...
                            {totalPages > 4 && (
                                <button
                                    ...
                                    className={`text-lg font-medium transition ${currentPage === totalPages
                                        ? 'flex h-12 w-12 items-center justify-center rounded-full bg-[#8b3dff] text-white md:h-14 md:w-14'
                                        : 'text-[#111827]'
                                        }`}
                                >
                            ...
                            <button
                                ...
                                className={`flex h-12 w-12 items-center justify-center rounded-full transition md:h-14 md:w-10 ${currentPage === totalPages
